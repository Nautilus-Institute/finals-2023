...
#ifndef __DRON_BLYAT_H
#define __DRON_BLYAT_H
 ...
 * frames from a DRON_BLYAT radio device.
 *
 ...
 * broadcasting the frames to all listening DRON_BLYAT radio
 * interfaces.
 *
 ...
 *	frames by any DRON_BLYAT radio device.
 ...
 *
 * @DRON_BLYAT_TX_RC_USE_RTS_CTS: Use RTS/CTS exchange for this rate.
 * @DRON_BLYAT_TX_RC_USE_CTS_PROTECT: CTS-to-self protection is required.
 *	This is set if the current BSS requires ERP protection.
 * @DRON_BLYAT_TX_RC_USE_SHORT_PREAMBLE: Use short preamble.
 * @DRON_BLYAT_TX_RC_MCS: HT rate.
 * @DRON_BLYAT_TX_RC_VHT_MCS: VHT MCS rate, in this case the idx field is
 *	split into a higher 4 bits (Nss) and lower 4 bits (MCS number)
 * @DRON_BLYAT_TX_RC_GREEN_FIELD: Indicates whether this rate should be used
 *	in Greenfield mode.
 * @DRON_BLYAT_TX_RC_40_MHZ_WIDTH: Indicates if the Channel Width should be
 *	40 MHz.
 * @DRON_BLYAT_TX_RC_80_MHZ_WIDTH: Indicates 80 MHz transmission
 * @DRON_BLYAT_TX_RC_160_MHZ_WIDTH: Indicates 160 MHz transmission
 *	(80+80 isn't supported yet)
 * @DRON_BLYAT_TX_RC_DUP_DATA: The frame should be transmitted on both of
 *	the adjacent 20 MHz channels, if the current channel type is
 *	NL80211_CHAN_HT40MINUS or NL80211_CHAN_HT40PLUS.
 * @DRON_BLYAT_TX_RC_SHORT_GI: Short Guard interval should be used for this
 *	rate.
 */
enum hwsim_tx_rate_flags {
	DRON_BLYAT_TX_RC_USE_RTS_CTS		= BIT(0),
	DRON_BLYAT_TX_RC_USE_CTS_PROTECT		= BIT(1),
	DRON_BLYAT_TX_RC_USE_SHORT_PREAMBLE	= BIT(2),

	/* rate index is an HT/VHT MCS instead of an index */
	DRON_BLYAT_TX_RC_MCS			= BIT(3),
	DRON_BLYAT_TX_RC_GREEN_FIELD		= BIT(4),
	DRON_BLYAT_TX_RC_40_MHZ_WIDTH		= BIT(5),
	DRON_BLYAT_TX_RC_DUP_DATA		= BIT(6),
	DRON_BLYAT_TX_RC_SHORT_GI		= BIT(7),
	DRON_BLYAT_TX_RC_VHT_MCS			= BIT(8),
	DRON_BLYAT_TX_RC_80_MHZ_WIDTH		= BIT(9),
	DRON_BLYAT_TX_RC_160_MHZ_WIDTH		= BIT(10),
};
